...
<div class="container-fluid text-center">
  ...
  <c:import url="/resources/images/QuickLinks.jsp" />
    ...
    <div class="col-sm-8">
      <input type="hidden" name="student_id" class="form-control" value="${studentObject.student_id}">
    </div>
  </div>
    <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <option value="${studentObject.concentration}">${studentObject.concentration}</option>
